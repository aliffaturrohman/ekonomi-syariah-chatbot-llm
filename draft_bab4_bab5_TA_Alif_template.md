...
## 4.1 Hasil Pre-processing Data

Tahap pre-processing dilakukan terhadap **[X] dokumen PDF** yang bersumber dari publikasi resmi OJK dan KNEKS, mencakup buku teks, modul pembelajaran, dan artikel ilmiah terkait ekonomi syariah. Proses ini menghasilkan total **[X] chunk** teks yang bersih dan terstruktur, dengan rata-rata panjang **[X] token per chunk**.

Distribusi dokumen berdasarkan sumber disajikan pada Tabel 4.1 berikut.

**Tabel 4.1 — Statistik Hasil Pre-processing Data**

| Sumber Dokumen | Jumlah Dokumen | Jumlah Chunk | Rata-rata Token/Chunk |
|---|---|---|---|
| Buku Teks OJK | [X] | [X] | [X] |
| Modul KNEKS | [X] | [X] | [X] |
| Artikel Ilmiah | [X] | [X] | [X] |
| **Total** | **[X]** | **[X]** | **[X]** |
...
> **[Catatan]:** Sertakan screenshot atau contoh potongan hasil chunk di sini jika tersedia.

---

## 4.2 Hasil Penyusunan Dataset RAFT
...
**Tabel 4.2 — Statistik Dataset RAFT**
...
## 4.3 Implementasi Fine-Tuning Model
...
### 4.3.1 Konfigurasi Hyperparameter Final

Berdasarkan serangkaian percobaan awal (*preliminary experiments*), konfigurasi hyperparameter final yang memberikan hasil terbaik adalah sebagaimana tercantum pada Tabel 4.3.

**Tabel 4.3 — Konfigurasi Hyperparameter Final**
...
> **[Gambar 4.1 — Training Loss Curve]**
...
## 4.4 Hasil Konversi dan Kuantisasi Model (GGUF)
...
**Tabel 4.4 — Perbandingan Ukuran Model Sebelum dan Sesudah Kuantisasi**
...
## 4.5 Implementasi LLM Service API
...
### 4.5.1 Daftar Endpoint API

**Tabel 4.5 — Daftar Endpoint API Chatbot**
...
### 4.5.2 Contoh Request dan Response
...
### 4.5.3 Hasil Pengujian Deployment
...
> **[Gambar 4.2 — Screenshot Hasil Pengujian Postman]**
> *(Sisipkan screenshot Postman di sini)*

---

## 4.6 Implementasi Integrasi Sistem Lintas Platform
...
> **[Gambar 4.3 — Screenshot Tampilan Chatbot pada Aplikasi Mobile/Web]**
